              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    SizedBox(
                        width: 150,
                        child: CustomButton(buttonName: "Submit", isLoading: false, isGradient: true, onTap: (){})),
                    SizedBox(
                        width: 150,
                        child: CustomButton(buttonName: "Cancel", isLoading: false, isGradient: false, onTap: (){
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: [
          Expanded(
            child: Text(file.path.split('/').last,style: const TextStyle(color: Colors.black),),
          ),
        ],
      ),
    );
