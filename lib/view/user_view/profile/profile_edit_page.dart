...
// Gender Dropdown List Data as List of Strings
...
// Annual Income Dropdown List Data as List of Strings
...
// Marital Status Dropdown List Data as List of Strings
  final List<String> _maritalStatus = [
    'Single',
    'Married',
  ];

// Occupation Dropdown List Data as List of Strings
  final List<String> _occupation = [
    'Service-Govt',
    'Job-Private',
    'Self-Employed',
    'Professional-Doctor-Engineer-Chartered Accountant-IT Professional',
    'Retired Personal',
    'Home Maker',
    'Student',
    'Any Other',
                        ...
                        case Status.NONE:
                          return const Padding(
                            ...
                            child: Column(
                              ...
                              mainAxisSize: MainAxisSize.max,
                              children: [
                                SizedBox(height: 300, child: Text("None"))
                              ],
                            ),
                          );
  ...
  Widget _maritalStatusField(
    ...
    return SizedBox(
        width: MediaQuery.sizeOf(context).width * 0.9,
        child: SingleDropdown(
          selectedValue: (profile.profileInfo.data?.marital == null ||
                  profile.profileInfo.data!.marital!.isEmpty)
              ? null
              : profile.profileInfo.data!.marital.toString(),
          dropdownListData: _maritalStatus,
          hintText: "Select Marital",
