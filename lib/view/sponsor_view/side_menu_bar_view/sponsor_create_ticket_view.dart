...
//
// class SponsorCreateTicketView extends StatefulWidget {
//   const SponsorCreateTicketView({super.key});
//
//   @override
//   State<SponsorCreateTicketView> createState() => _SponsorCreateTicketViewState();
// }
//
// class _SponsorCreateTicketViewState extends State<SponsorCreateTicketView> {
...
//
//
//     username = await _authService.getSponsorName() ?? '';
//     email = await _authService.getSponsorEmail() ?? '';
//
//     setState(() {
...
//       final provider = Provider.of<SponsorCreateTicketViewModel>(context, listen: false);
...
//     File? file = await _mediaServices.getSingleFileFromPicker(isImage: true);
//
//     final provider = Provider.of<SponsorCreateTicketViewModel>(context, listen: false);
//     if (file != null) {
...
//         ),
//         Consumer<SponsorCreateTicketViewModel>(builder: (context, provider, _) {
//
